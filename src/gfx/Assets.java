...
public class Assets {
    ...
    public static void init ( ) /// incarca tot ce trebe pentru joc
    {
        ...
        player_right[1] = sheet.crop(82,717,29,51);
        player_right[2] = sheet.crop(146,717,29,51);
        player_right[3] = sheet.crop(210,717,27,51);
        player_right[4] = sheet.crop(273,717,28,51);
        player_right[5] = sheet.crop(335,717,31,51);
        player_right[6] = sheet.crop(401,717,28,51);
        player_right[7] = sheet.crop(466,717,26,51);
        player_right[8] = sheet.crop(530,717,27,51);
        player_idle = new BufferedImage[4];
        player_idle[0] = sheet.crop(16,141,33,54);
        player_idle[1] = sheet.crop(80,141,33,54);
        player_idle[2] = sheet.crop(145,141,30,54);
        player_idle[3] = sheet.crop(205,141,39,54);
        player_left = new BufferedImage[9];
        player_left[0] = sheet.crop(20,589,26,52);
        player_left[1] = sheet.crop(80,589,31,52);
        player_left[2] = sheet.crop(146,589,28,52);
        player_left[3] = sheet.crop(212,589,27,52);
        player_left[4] = sheet.crop(276,589,28,52);
        player_left[5] = sheet.crop(338,589,32,52);
        player_left[6] = sheet.crop(403,589,29,52);
        player_left[7] = sheet.crop(468,589,27,52);
        player_left[8] = sheet.crop(532,589,26,52);
        player_ladder = new BufferedImage[9];
        player_ladder[0] = sheet.crop(16,524,33,54);
        player_ladder[1] = sheet.crop(80,524,34,54);
        player_ladder[2] = sheet.crop(144,524,33,54);
        player_ladder[3] = sheet.crop(209,524,31,54);
        player_ladder[4] = sheet.crop(272,524,33,54);
        player_ladder[5] = sheet.crop(336,524,33,54);
        player_ladder[6] = sheet.crop(400,524,33,54);
        player_ladder[7] = sheet.crop(465,524,32,54);
        player_ladder[8] = sheet.crop(528,524,33,54);
        player_attack_left = new BufferedImage[6];
        player_attack_left[0] = sheet.crop(7,844,39,53);
        player_attack_left[1] = sheet.crop(80,844,28,53);
        player_attack_left[2] = sheet.crop(145,844,29,53);
        player_attack_left[3] = sheet.crop(201,844,38,53);
        player_attack_left[4] = sheet.crop(255,844,47,53);
        player_attack_left[5] = sheet.crop(320,844,45,53);
        player_attack_right = new BufferedImage[6];
        player_attack_right[0] = sheet.crop(19,972,38,54);
        player_attack_right[1] = sheet.crop(85,972,28,54);
        player_attack_right[2] = sheet.crop(147,972,30,54);
        player_attack_right[3] = sheet.crop(210,972,37,54);
        player_attack_right[4] = sheet.crop(276,972,46,54);
        player_attack_right[5]= sheet.crop(339,972,47,54);
